...
app.get('/api/musicList/', (req,res)=>{
  ...
  app.get('/api/musicList', (req, res) => {
    ...
    if (!req.body.month || !req.body.year)
    {
        if (req.body.month)   
        {
            music = musicList.filter(s => s.month === req.body.month);
        }
        if (req.body.year)
        {
            music = musicList.filter(s => s.year === req.body.year);
        } 
    }
    else if (req.body.month && req.body.year)
    {
        music = musicList.filter(s => s.month === req.body.month && s.year === req.body.year);
    }
